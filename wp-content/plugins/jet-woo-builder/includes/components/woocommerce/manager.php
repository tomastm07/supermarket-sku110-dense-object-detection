	...
	class Jet_Woo_Builder_Woocommerce {
		...
		public function taxonomy_add_form_fields() {
			...
			<div class="form-field">
				...
				<p><?php echo __( 'It will be applied on singular layout of this term.', 'jet-woo-builder' ); ?></p>
			</div>
		...
		public function taxonomy_edit_forms_fields( $term ) {
			...
			<tr class="form-field">
				...
				<td>
					<select name="jet_woo_builder_template" id="jet_woo_builder_template">
						<?php foreach ( $templates as $template_id => $template_title ) : ?>
							<option value="<?php echo esc_attr( $template_id ); ?>" <?php selected( $custom_template, $template_id ); ?>><?php echo esc_attr( $template_title ); ?></option>
						<?php endforeach; ?>
					</select>
					<p><?php echo __( 'It will be applied on singular layout of this term.', 'jet-woo-builder' ); ?></p>
				</td>
